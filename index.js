...
allCategory.appendChild(heading);
  ...
  const categoryContainer = document.createElement("div");
      categoryContainer.innerHTML = `<button class="text-green-900 text-left hover:bg-green-800 hover:text-white hover:rounded-sm p-2">${category.category_name}</button>`;
